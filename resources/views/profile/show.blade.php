...
<div class="container-fluid rounded bg-white mt-5 mb-5">
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://www.thelocal.dk/images/person-placeholder.svg">
                <span class="font-weight-bold" style="color: #1f2c73; ">{{$user->name}}</span>
                <span class="text-black-50">{{$user->email}}</span>
                <span style="color: #1f2c73;"> {{$user->identifier_id}}</span>
            </div>
        </div>
        ...
        <input type="middlename" name="middlename" id="middlename" class="form-control" value="{{@old('middlename', $user->middlename)}}" required/>
...
<div class="d-flex justify-content-between align-items-center mt-4 mb-3">
    ...
    <div class="col-md-6">
        <label for="discounts" class="labels">Discounts:</label>
    ...
    <div class="col-md-6">
        <label for="seat" class="labels">Seat:</label>
    ...
    <div class="col-md-6">
        <label for="seating_section" class="labels">Seating Section:</label>
    ...
    <div class="col-md-6">
        <label for="special_meals" class="labels">Special Meals:</label>
    ...
    <div class="col-md-6">
        <label for="preffered_departure_airport" class="labels">Preffered Departure Airport:</label>
    ...
    <div class="col-md-6">
        <label for="other_travel_preferences" class="labels">Other Travel Preferences:</label>
    ...
    <div class="col-md-6">
        <label for="medical_alerts" class="labels">Medical Alerts:</label>
    ...
    <div class="col-md-6">
        <label for="room_type" class="labels">Room Type:</label>
    ...
    <div class="col-md-6">
        <label for="smoking" class="labels">Smoking:</label>
    ...
    <div class="col-md-6">
        <label for="foam_pillow" class="labels">Foam Pillow:</label>
    ...
    <div class="col-md-12">
        <label for="message_to_car_hotel_vendor" class="labels">Message To Car Hotel Vendor:</label>
    ...
    <div class="mb-3">
        <label for="accesibilty_need" class="labels">Accesibilty Need:</label>
    ...
    <div class="col-md-6">
        <label for="car_smoking" class="labels">Car Smoking:</label>
    ...
    <div class="col-md-6">
        <label for="car_transmission" class="labels">Car Transmission:</label>
    ...
    <div class="col-md-12">
        <label for="car_gps" class="labels">Car Gps:</label>
...
<div class="col-md-12">
        <label for="message_to_car_rental_vendor" class="labels">Message To Car Rental Vendor:</label>
...
<div class="col-md-6">
        <label for="frequent_traveller_number" class="labels">Frequent Traveller Number:</label>
    ...
    <div class="col-md-6">
        <label for="frequent_traveller_number_hotel_chain" class="labels">Frequent Traveller Number Hotel Chain:</label>
    ...
    <div class="col-md-6">
        <label for="frequent_traveller_gender" class="labels">Frequent Traveller Gender:</label>
    ...
    <div class="col-md-6">
        <label for="dhs_redress_number" class="labels">Dhs Redress Number:</label>
    ...
    <div class="col-md-6">
        <label for="tsa_precheck_number" class="labels">Tsa Precheck Number:</label>
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-3">
                    <h4 class="text-right">Passports</h4>
                </div>

<div class="col-md-6">
        <label for="do_you_have_a_passport" class="labels">Do You Have A Passport:</label>
    ...
    <div class="col-md-6">
        <label for="passport_nationality" class="labels">Passport Nationality:</label>
    ...
    <div class="col-md-6">
        <label for="passport_number" class="labels">Passport Number:</label>
    ...
    <div class="col-md-6">
        <label for="passport_date_issued" class="labels">Passport Date Issued:</label>
    ...
    <div class="col-md-6">
        <label for="passport_date_expiry" class="labels">Passport Date Expiry:</label>
    ...
    <div class="col-md-6">
        <label for="passport_issued_place" class="labels">Passport Issued Place:</label>
    ...
    <div class="col-md-6">
        <label for="passport_issued_country" class="labels">Passport Issued Country:</label>
    ...
    <div class="col-md-6">
        <label for="visa_nationality" class="labels">Visa Nationality:</label>
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-3">
                    <h4 class="text-right">Visas</h4>
                </div>


    <div class="col-md-12">
        <label for="visa_type" class="labels">Visa Type:</label>
    ...
    <div class="col-md-12">
        <label for="visa_number" class="labels">Visa Number:</label>
    ...
    <div class="col-md-12">
        <label for="visa_number_expiration" class="labels">Visa Number Expiration:</label>
