...
@section('users.content')
    ...
    <div class="mb-3">
        ...
        <input type="text" name="identifier_id" id="identifier_id" class="form-control" value="{{@old('identifier_id')}}" required/>
    ...
    <div class="mb-3">
        ...
        <textarea name="two_factor_secret" id="two_factor_secret" class="form-control" >{{@old('two_factor_secret')}}</textarea>
    ...
    <div class="mb-3">
        ...
        <textarea name="two_factor_recovery_codes" id="two_factor_recovery_codes" class="form-control" >{{@old('two_factor_recovery_codes')}}</textarea>
    ...
    <div class="mb-3">
        ...
        <input type="number" name="current_team_id" id="current_team_id" class="form-control" value="{{@old('current_team_id')}}" />
    ...
    <div class="mb-3">
        ...
        <textarea name="profile_photo_path" id="profile_photo_path" class="form-control" >{{@old('profile_photo_path')}}</textarea>
