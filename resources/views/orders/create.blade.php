  ...
  This section is coming soon. 
        ...
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <h5>Create a Travel Recquest</h5>
            </div>

            <div class="card-body">
                <form action="{{ route('orders.store', []) }}" method="POST" class="m-0 p-0">
                    <div class="card-body">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="date" name="dateoftravel" id="dateoftravel" class="form-control" value="{{@old('dateoftravel')}}" />
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('orders.index', []) }}" class="btn btn-light">@lang('Cancel')</a>
